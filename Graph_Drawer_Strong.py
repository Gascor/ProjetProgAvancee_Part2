...
data_file = "Data/results_pi_strong_MSIVECTOR_Effectiveness.csv"  # Utilisez le chemin complet ici
...
plt.title("""Moyenne du Graphique de Scalabilité Forte (Speed-up) avec Ntot = 16 Millions | Calculs sur Pi.java
...
combined_output_file = "doc/Docs/graph/pi_strong_mean_speedup_MSIVECTOR_Effectiveness.png"  # Utilisez le chemin complet ici
